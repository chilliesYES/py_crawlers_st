...
//    Wo7h.md = ["色", "流感", "这边", "弱", "嘴唇", "亲", "开心", "呲牙", "憨笑", "猫", "皱眉", "幽灵", "蛋糕", "发怒", "大哭", "兔子", "星星", "钟情", "牵手", "公鸡", "爱意", "禁止", "狗", "亲亲", "叉", "礼物", "晕", "呆", "生病", "钻石", "拜", "怒", "示爱", "汗", "小鸡", "痛苦", "撇嘴", "惶恐", "口罩", "吐舌", "心碎", "生气", "可爱", "鬼脸", "跳舞", "男孩", "奸笑", "猪", "圈", "便便", "外星", "圣诞"]
//}

// bvg3x(["流泪", "强"])   bvg3x(Wo7h.md)  bvg3x(["爱心", "女孩", "惊恐", "大笑"]
...
rawdata = {
 ...
 var bKP0x = window.asrsea(JSON.stringify(rawdata), aa, bb, cc));
            e6c.data = j6d.cq6k({
                params: bKP0x.encText,
                encSecKey: bKP0x.encSecKey
                })